...
codeunit 80100 "KLT API Auth"
{
    ...
    begin
        case APIConfig."Authentication Method" of
            ...
            APIConfig."Authentication Method"::Windows:
                begin
                    // BC17 does not support UseDefaultCredentials()
                    ...
                    Error('Windows authentication is not supported in BC17. Please use OAuth, Basic, or Certificate authentication.');
                end;
            APIConfig."Authentication Method"::Certificate:
                begin
    ...
    begin
        ...
        // In BC17, certificate handling is different
        ...
        Error('Certificate authentication requires manual certificate configuration in BC17. Please contact your administrator.');
    end;
