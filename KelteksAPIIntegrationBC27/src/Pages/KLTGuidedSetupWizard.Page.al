...
page 80103 "KLT Guided Setup Wizard"
{
    ...
    Caption = 'Kelteks API Setup Wizard (BC27)';
        ...
        area(Content)
        {
            ...
            group(Step1)
            {
                ...
                group(Step1Intro)
                {
                    ...
                    InstructionalText = 'This wizard will guide you through setting up the API integration between BC27 and BC17 for Fiskalizacija 2.0 compliance. The wizard will auto-detect your environment and pre-fill settings with sensible defaults.';
                }
            ...
            group(Step2)
            {
                ...
                group(Step2Intro)
                {
                    Caption = 'Step 2: Configure Target BC17 Connection';
                    InstructionalText = 'Specify the connection details for your BC17 environment. The wizard has pre-filled default values based on your deployment type.';
                }
                ...
                group(Step2Content)
                {
                    ...
                    field("Target Base URL"; TargetBaseURL)
                    {
                        ...
                        ToolTip = 'Specifies the base URL for BC17. Pre-filled with recommended default.';
                        ShowMandatory = true;
                    ...
                    field("Server Name Hint"; ServerNameHint)
                    {
                        ...
                        ToolTip = 'For on-premise: Enter BC17 server name or IP to auto-generate URL';
            ...
            group(Step3)
            {
                ...
                group(Step3Intro)
                {
                    ...
                    InstructionalText = 'Enter the credentials for connecting to BC17. Ensure you have a service account with appropriate permissions.';
                }
                ...
                group(Step3Certificate)
                {
                    ...
                    group(CertInfo)
                    {
                        ...
                        InstructionalText = 'Ensure the client certificate is installed on this BC27 server for authenticating to BC17.';
                    }
                }
            }
    ...
    begin
        ...
        case DeploymentType of
            DeploymentType::OnPremise:
                URLExamplesTxt := 'On-Premise: https://bc17-server:7048/BC170/ODataV4/\n\nReplace "bc17-server" with your actual server name or IP address.';
            DeploymentType::SaaS:
